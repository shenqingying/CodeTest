...
using Sonluk.UI.Model.FICO;

namespace Sonluk.PC.Models
{
    public class CRMModels
    {
        private ORDER_SH _ORDER_SH;
        ...
        private KH_GROUP_XSQY _KH_GROUP_XSQY;
        ...
        private HG_STAFFDUTY _HG_STAFFDUTY;
        ...
        private HG_RIGHTGROUP _HG_RIGHTGROUP;
        ...
        public COST_ZZFSJT COST_ZZFSJT
      {
        ...
        PRODUCT_PRODUCT_HH _PRODUCT_PRODUCT_HH;
        ...
        WS_BC_DRF _WS_BC_DRF;

        public WS_BC_DRF WS_BC_DRF
        {
            get {
                if (_WS_BC_DRF == null)
                {
                    _WS_BC_DRF = new WS_BC_DRF();
                }
                return _WS_BC_DRF; }
            set { _WS_BC_DRF = value; }
        }
