...
function LoadTableData() {
    ...
    data = {
        DID: $('#in_bm').val() == '' ? 0 : $('#in_bm').val(),
        KSTIME: $('#in_time_ks').val(),
        JSTIME: $('#in_time_ks').val(),
        POINTID: $('#in_CheckPoint').val() == '' ? 0 : $('#in_CheckPoint').val(),
        NUM: $('#in_NUM').val()
    }
    var result;
    $.ajax({
        ...
        table.render({
            ...
            cols: [[ //表头
             ...
             { title: '序号', templet: '#indexTpl', width: 60 },
              { field: 'POINTMS', title: '检查点描述', width: 180 },
              { field: 'LOCATIONMS', title: '检查点位置', width: 120 },
