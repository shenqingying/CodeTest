...
layui.use(['form', 'laydate', 'element', 'laydate', 'table'], function () {
    ...
    $("#btn_clear").click(function () {
        layer.confirm('确认要清空当前检测模具么？', function (index) {
            if ($("#BL_SBBH").val() !== "") {
                var datastring = {
                    SBBH: $("#BL_SBBH").val(),
                    ISFREE: 1,
        ...
        success: function (data) {
            ...
            if (resdata.MES_RETURN.TYPE !== "S") {
                ...
                if (resdata.MES_ZS_QJ_QJSB.length > 0) {
                    if (resdata.MES_ZS_QJ_QJSB[0].CZLB === 2) {
                        ...
                        $("#BL_JLMXID").val(resdata.MES_ZS_QJ_QJSB[0].JLMXID);
                    }
                    else {
                        $("#lb_mould").html("");
                        $("#lb_wlxx").html("");
            ...
            if (resdata.MES_RETURN.TYPE !== "S") {
                ...
                if (resdata.MES_TM_TMINFO_LIST.length === 0) {
                    ...
                    if (resdata.MES_TM_TMINFO_LIST[0].MOULD === "") {
                        ...
                        if (resdata.MES_TM_TMINFO_LIST[0].DCXHMS !== $("#show_sbfl").val() && $("#show_sbfl").val() !== "") {
