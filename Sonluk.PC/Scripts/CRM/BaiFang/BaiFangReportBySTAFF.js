        ...
        success: function (resdata) {
            ...
            table.render({
                ...
                cols: [[ //表头
                  ...
                  { field: 'STAFFNAME', title: '人员姓名', width: 200, event: 'click' },
                  { field: 'STAFFNO', title: '人员工号', width: 120, event: 'click' },
                  { field: 'DEPNAME', title: '部门', width: 110, event: 'click' },
                  { field: 'TOTAL_COUNT', title: '已拜访次数', width: 110, event: 'click' },
...
$(document).ready(function () {
    ...
    $("#btn_daochu").click(function () {
        ...
        $.ajax({
            type: "POST",
            async: true,
            url: "../BaiFang/Data_Daochu_BaiFangSummaryAndMX",
            data: {
                cxdata: JSON.stringify(cxdata),
