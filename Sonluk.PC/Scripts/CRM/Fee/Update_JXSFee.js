                        ...
                        if (res.KEY > 0) {
                            ...
                            layer.open({
                                ...
                                yes: function (index, layero) {
                                    ...
                                    location.href = "../Fee/Select_JXSFee";
                                    layer.close(index);
        ...
        if (obj.event == 'delete') {
            ...
            layer.open({
                ...
                yes: function (index, layero) {
                    ...
                    obj.data.HFYJ = $("#OPINION").val();
                 //   obj.data.SPZT = $("#sp_altitude").val();

                    $.ajax({
                        type: "POST",
                        async: false,
                        url: "../Fee/Update_File2",
                        data: {
...
//广告完成画面单独上传接口
function TableLoad_wjggwc(GSDXID, GSDX, elem, titlt) {
    var table = layui.table;
    $.ajax({
        type: "POST",
        //async: false,
        ...
        success: function (resdata) {
            ...
            table.render({
                ...
                cols: [[ //表头
                  ...
                  { field: 'WJM', title: titlt, width: 300, style: 'height:100px', templet: '#imgTpl', align: 'center' },
                  //{ field: 'IMGSOURCE', title: '照片来源', width: 110 },
                 { fixed: 'right', width: 150, align: 'center', toolbar: '#tb_ggwc' }
                ]]
            });
            $("img.mytableimg").parent().css("height", "auto");
        },
        ...
        success: function (resdata) {
            ...
            table.render({
                ...
                cols: [[ //表头
                 ...
                 { width: 180, align: 'center', toolbar: '#tb_fujian2' }
                ]]
            });
            $("img.mytableimg").parent().css("height", "auto");
        },
