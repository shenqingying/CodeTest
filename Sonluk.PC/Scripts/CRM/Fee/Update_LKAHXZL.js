...
function TableLoad_general() {
    ...
    { field: 'CJSJ', title: '填写日期', width: 120, rowspan: 2 },
    { field: 'FYHXYHCNR', title: '费用核销员核查内容', width: 200, rowspan: 2 },
    { field: 'BEIZ', title: '回退情况说明', width: 200, rowspan: 2 },
    { field: 'ISACTIVE', title: '审核状态', width: 100, rowspan: 2, templet: '#Tpl_zhuangtai' },
    ...
    { field: 'FYBCSQJE', title: '本次申请核销金额', width: 150 },
     { field: 'MCHTQKDES', title: '合同版本', width: 90 },
    { field: 'MCHTTK', title: '合同条款', width: 90 },
    { field: 'MCHTJE', title: '合同金额', width: 90 },
    { field: 'CSKKFPDES', title: '超市发票', width: 100 },
    { field: 'CSKKFPDY', title: '系统扣款明细', width: 120, templet: '#Tpl_kkmx' }
            ...
            for (var i = 0; i < data.length; i++) {
                if (data[i].ISACTIVE == 10 || data[i].ISACTIVE == 15) {
                    $("#h2_general").html("常规费用(待处理)" + '<i class="layui-icon layui-colla-icon"></i>');
                    return false;
                }
            }
        },
        ...
        success: function (result) {
            ...
            table.render({
                ...
                cols: [[ //表头
                  ...
                  { field: 'MDMC', title: '门店名称', width: 160 },
        ...
        success: function (result) {
            ...
            table.render({
                ...
                cols: [[ //表头
                    { type: 'checkbox' },
                        { title: '序号', templet: '#indexTpl', width: 60 },
                        { field: 'COSTITEMIDDES', title: '项目', width: 120, sort: true },
                        { field: 'ZZLXDES', title: '制作类型', width: 200 },
...
function TableLoad_other() {
    ...
    { field: 'FYYHXJE', title: '已核销金额', width: 100 },
    { field: 'FYBCSQJE', title: '本次申请核销金额', width: 150 },
     { field: 'MCHTQK', title: '合同版本', width: 150 },
    { field: 'MCHTTK', title: '合同条款', width: 120 },
    { field: 'MCHTJE', title: '合同金额', width: 120 },
    { field: 'CSKKFPDES', title: '超市发票', width: 120 },
    { field: 'CSKKFPDY', title: '系统扣款明细', width: 100, templet: '#Tpl_kkmx' }
            ...
            for (var i = 0; i < data.length; i++) {
                if (data[i].ISACTIVE == 10 || data[i].ISACTIVE == 15) {
                    $("#h2_other").html("其他费用(待处理)" + '<i class="layui-icon layui-colla-icon"></i>');
                    return false;
                }
            }
        },
        ...
        success: function (result) {
            ...
            table.render({
                ...
                cols: [[ //表头
                  ...
                  { field: 'CJHDMDSL', title: '参加活动门店数量', width: 120 },
                  { field: 'HDBEGINDATE', title: '活动开始时间', width: 120 },
                  { field: 'HDENDDATE', title: '活动结束时间', width: 120 },
                  { field: 'DP1DES', title: '单品1', width: 100 },
                  { field: 'DP2DES', title: '单品2', width: 100 },
            ...
            for (var i = 0; i < data.length; i++) {
                if (data[i].ISACTIVE == 10 || data[i].ISACTIVE == 15) {
                    $("#h2_FYother").html("其他费用-补损费(待处理)" + '<i class="layui-icon layui-colla-icon"></i>');
                    return false;
                }
            }
        },
        ...
        success: function (result) {
            ...
            table.render({
                ...
                cols: [[ //表头
                 ...
                 { field: 'KHZZSJ', title: '客户开发时间', width: 120 },
...
$(document).ready(function () {
        ...
        if ($("#isactive").val() == 1) {
            layer.open({
                ...
                yes: function (index, layero) {
                    location.href = "../Fee/Select_LKAHXZL";
                    layer.close(index);
                }
            });
        }
    ...
    //常规费用
    $("#btn_insert_general").click(function () {
        ...
        layer.open({
            ...
            //btn: ['保存', '取消'],
            success: function () {
                $("#div_insert_general2").show();
                $("#div_md").hide();
                $("#div_insert_general_beiz").hide();
            },
            yes: function (index, layero) {
    ...
    form.on('select(insert_general_item)', function (data) {
        ...
        $.ajax({
            type: "POST",
            async: true,
            url: "../Fee/Data_Select_LKAHXZLMXinfo",
            data: {
                cxdata: JSON.stringify(cxdata),
                HTYEAR: $("#htyear").val(),
                LKAID: $("#LKAID").val()
            ...
            success: function (result) {
                ...
                $("#COSTID").val(res.COSTID);
                $("#insert_general_spje").val(res.FYSPJE);
                $("#insert_general_yhxje").val(res.FYYHXJE);
    ...
    $("#btn_insert_general_save").click(function () {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (res.KEY > 0) {
                    ...
                    if ($("#insert_general_item").val() == 8) {
                        TableLoad_md(res.KEY);
                        $("#div_md").show();
                        $("#div_insert_general2").hide();
                        $("#HXZLMXID").val(res.KEY);
                    }
                    else {
                        layer.closeAll();
                    }
    ...
    $("#btn_submit_general").click(function () {
    ...
    $("#btn_insert_haibao").click(function () {
        ...
        layer.open({
            ...
            yes: function (index, layero) {
                ...
                $("#insert_haibao_LKAFYTTID").val("");
                $("#insert_haibao_hbyj").val(0);
    ...
    form.on('select(insert_haibao_item)', function (data) {
        if (data.value != 0) {
            TableLoad_insert_haibao();
        }
    ...
    $("#insert_haibao_sjxs").change(function () {
        if ($("#insert_haibao_sjxs").val() != "" && $("#insert_haibao_sjxs").val() != 0) {
            $("#insert_haibao_sjfb").val(parseFloat(($("#insert_haibao_apply_costHJ").val()) / parseFloat($("#insert_haibao_sjxs").val()) * 100).toFixed(2) + "%");
        }
    });
    $("#btn_save_haibao").click(function () {
        ...
        if ($("#insert_haibao_hbyj").val() == 0) {
            layer.msg("请选择是否有海报原件");
            return false;
        }
        ...
        var data = {
            HXZLTTID: $("#HXZLTTID").val(),
            LKAFYTTID: $("#insert_haibao_LKAFYTTID").val(),
            COSTITEMID: $("#insert_haibao_item").val(),
            FYSPJE: $("#insert_haibao_apply_cost").val(),
            FYYHXJE: 0,
            FYBCSQJE: $("#insert_haibao_apply_cost").val(),
            SFYHBYJ: $("#insert_haibao_hbyj").val(),
            SQZJE: $("#insert_haibao_apply_costHJ").val(),
    ...
    $("#btn_insert_SpecialDisplay").click(function () {
        ...
        layer.open({
            ...
            success: function () {
                ...
                $("#div_insert_SpecialDisplay_beiz").hide();
            },
            yes: function (index, layero) {
    ...
    $("#insert_SpecialDisplay_sjxs").change(function () {
        if ($("#insert_SpecialDisplay_sjxs").val() != "" && $("#insert_SpecialDisplay_sjxs").val() != 0) {
            $("#insert_SpecialDisplay_sjfb").val(parseFloat(($("#insert_SpecialDisplay_apply_cost").val()) / parseFloat($("#insert_SpecialDisplay_sjxs").val()) * 100).toFixed(2) + "%");
        }
    });
    $("#btn_save_SpecialDisplay").click(function () {
        ...
        var data = {
            ...
            HDJSZJ: $("#insert_SpecialDisplay_zj").val(),
    ...
    //        type: "POST",
    //        async: false,
    //        url: "../Fee/Data_Insert_LKAXSMXXXXX",
    //        data: {
    //            data: JSON.stringify(data)
    //        },
    //        success: function (result) {
    ...
    //其他费用
    $("#btn_insert_other").click(function () {
    ...
    form.on('select(insert_other_item)', function (data) {
        ...
        $.ajax({
            ...
            success: function (result) {
                var res = JSON.parse(result);
                $("#COSTID").val(res.COSTID);
                $("#insert_other_spje").val(res.FYSPJE);
                $("#insert_other_yhxje").val(res.FYYHXJE);
    ...
    $("#btn_submit_other").click(function () {
    ...
    //单独申报的其他费用
    $("#btn_insert_FYother").click(function () {
        ...
        layer.open({
            ...
            //btn: ['确定', '取消'],
            success: function () {
                TableLoad_insert_FYother();
                $("#div_insert_FYother_beiz").hide();
            },
            yes: function (index, layero) {
    ...
    $("#insert_FYother_sjxs").change(function () {
        if ($("#insert_FYother_sjxs").val() != "" && $("#insert_FYother_sjxs").val() != 0) {
            $("#insert_FYother_sjfb").val(parseFloat(($("#insert_FYother_apply_costHJ").val()) / parseFloat($("#insert_FYother_sjxs").val()) * 100).toFixed(2) + "%");
        }
    });
    $("#btn_save_FYother").click(function () {
        ...
        var data = {
            HXZLTTID: $("#HXZLTTID").val(),
            LKAFYTTID: $("#insert_FYother_LKAFYTTID").val(),
            COSTITEMID: 13,
            FYSPJE: $("#insert_FYother_apply_cost").val(),
            FYYHXJE: 0,
            FYBCSQJE: $("#insert_FYother_apply_costHJ").val(),
            SQZJE: $("#insert_FYother_apply_costHJ").val(),
    ...
    $("#btn_submit_FYother").click(function () {
    ...
    $("#btn_insert_md").click(function () {
        ...
        var checkStatus = table.checkStatus('tb_md');
        if (checkStatus.data.length != 0) {
            layer.msg("最多只可关联一个门店！");
            return false;
        }
            ...
            if (obj.event == 'edit') {
                ...
                layer.open({
                    ...
                    success: function () {
                        ...
                        $("#btn_insert_general_save").hide();
                        $("#div_insert_general2").show();
                        $("#div_md").hide();

                        if (data.ISACTIVE == 15)
                            $("#div_insert_general_beiz").show();
                        else
                            $("#div_insert_general_beiz").hide();
            ...
            if (obj.event == 'edit') {
                ...
                layer.open({
                    ...
                    success: function () {
                        ...
                        $("#insert_haibao_hbyj").val(data.SFYHBYJ);
                        ...
                        if (data.ISACTIVE == 15)
                            $("#div_insert_haibao_beiz").show();
                        else
                            $("#div_insert_haibao_beiz").hide();


                        if (data.COSTITEMID == 11) {
                            $("#div_hbyj").show();
                        }
                        else {
                            $("#div_hbyj").hide();
            ...
            if (obj.event == 'edit') {
                ...
                layer.open({
                    ...
                    success: function () {
                        ...
                        $("#insert_SpecialDisplay_zj").val(data.HDJSZJ);
                        ...
                        if (data.ISACTIVE == 15)
                            $("#div_insert_SpecialDisplay_beiz").show();
                        else
                            $("#div_insert_SpecialDisplay_beiz").hide();
