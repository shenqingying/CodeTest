    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            table.render({
                ...
                { fixed: 'right', width: 240, align: 'right', toolbar: '#bar' }
                ]]
            });
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (res.KEY > 0) {
                    //TableLoad();
                    //layer.close(layer1);
                    location.href = "../Fee/Update_LKAyear_UpdateAll?LKAYEARTTID=" + res.KEY;
                }
    ...
    layui.use(['form', 'layer', 'element', 'laydate', 'upload'], function () {
        ...
        table.on('tool(result)', function (obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
            ...
            if (obj.event == 'watch') {
                ...
                window.open("../Fee/Update_LKAyear_UpdateAll?LKAYEARTTID=" + obj.data.LKAYEARTTID);
            }
