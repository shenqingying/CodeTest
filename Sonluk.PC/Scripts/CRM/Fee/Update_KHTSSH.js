...
$(document).ready(function () {
    ...
    TableLoad_wjjl(TSID, 24, "pic_tsfj", "投诉结果反馈照片");//投诉结果反馈照片
            ...
            if (obj.event == 'edit') {
                ...
                layer.open({
                    ...
                    success: function (layero, index) {
                        //读取对应的照片信息加载到表格中
                        TableLoad_wjjl(TSID, 21, "pic_display004", "投诉照片");
                    },
                    end: function () {
                        $("#004p").hide();
                    }
                ...
                yes: function (index, layero) {
                    ...
                    $.ajax({
                        ...
                        success: function (id) {
                            if (id > 0) {
                                // var disID = parseInt($("#SJTID").val());
                                TableLoad_wjjl(TSID, 24, "pic_tsfj", "投诉结果反馈照片");
                                layer.msg("删除成功！");
                            }
                            else
                                layer.msg("删除失败");
    ...
    layui.use(['form', 'layer', 'element', 'laydate', 'upload', 'table'], function () { //上传附件
        ...
        upload.render({
            ...
            before: function () {
                ...
                TableLoad_wjjl(TSID, 21, "pic_display004", "陈列照片");
            },
            error: function () {
                //请求异常回调
                //layer.msg("上传失败");
