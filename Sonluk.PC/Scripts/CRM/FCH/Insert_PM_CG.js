        ...
        try {
            ...
            $.ajax({
                ...
                success: function (reslist) {
                    ...
                    if (res.ET_RETURN.length != 0 && res.ET_RETURN[0].TYPE == "E") {
                        layer.alert(res.ET_RETURN[0].MESSAGE);
                        layer.close(layindex);
                        return false;
                    }
                    $("#WLH").val(res.ES_POITEM.MATNR);
                    $("#Material_Name").val(res.ES_POITEM.MAKTX);
                    //$("#date").val(res.ES_POITEM.CHARG);
