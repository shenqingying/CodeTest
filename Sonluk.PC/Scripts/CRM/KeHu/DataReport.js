    ...
    $.ajax({
        ...
        success: function (list) {
            ...
            table.render({
                ...
                cols: [[ //表头
                    { type: 'checkbox', fixed: 'left' },
                    { title: '序号', templet: '#indexTpl', width: 60, event: 'watch', fixed: 'left' },
                { field: 'JXSNAME', title: '经销商名称', width: 200, event: 'watch', fixed: 'left' },
                { field: 'MC', title: '网点名称', width: 200, event: 'watch', fixed: 'left' },
                { field: 'CZSJ', title: '客户创建时间', width: 180, event: 'watch' },
                { field: 'CZRDES', title: '创建人', width: 100, event: 'watch' },
                ...
                { field: 'ImgSPcount', title: '陈列照片是否审核通过', width: 190, event: 'watch', templet: '#imgSP' },
                { field: 'DisplayItemCount', title: '是否有双鹿陈列道具', width: 180, event: 'watch', templet: '#itemSP' },
...
function TableLoad_lka(cxdata) {
    ...
    $.ajax({
        type: "POST",
        async: true,
        url: "../KeHu/Data_Select_LKAreport",
        data: {
            cxdata: JSON.stringify(cxdata)
        },
        success: function (list) {
            ...
            table.render({
                ...
                cols: [[ //表头
                    ...
                    { title: '序号', templet: '#indexTpl', width: 60, event: 'watch', fixed: 'left' },
                { field: 'JXSNAME', title: '经销商名称', width: 200, event: 'watch', fixed: 'left' },
                { field: 'PKHMC', title: '卖场名称', width: 120, event: 'watch', fixed: 'left' },
                { field: 'MC', title: '门店名称', width: 200, event: 'watch', fixed: 'left' },
                { field: 'SFDES', title: '省份', width: 100, event: 'watch' },
                { field: 'CSDES', title: '城市', width: 100, event: 'watch' },
                { field: 'CZSJ', title: '客户创建时间', width: 180, event: 'watch' },
                { field: 'CZRDES', title: '创建人', width: 100, event: 'watch' },
        ...
        switch ($("#report_type").val()) {
            ...
            case "2":
                cxdata = {
                    ...
                    HDMC: $("#zdwd_HDMC").val(),
                    DISPLAY_STATUS: $("#zdwd_display_status").val(),
                    DISPLAYITEM: $("#zdwd_displayitem").val(),
                    HUODONG_STATUS: $("#zdwd_HDimg_status").val()
