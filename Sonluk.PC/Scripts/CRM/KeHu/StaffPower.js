...
function TableLoad_group(selectGID) {
    ...
    $.ajax({
        type: "POST",
        //async: false,
        url: "../KeHu/Data_Select_KH_Group_Staff",
        data: {
            staffname: $("#name").val(),
            GID: selectGID
        },
        success: function (resdata) {
            ...
            table.render({
                ...
                { field: 'STAFFIDDES', title: '人员名称', width: 120 },
                { field: 'GIDDES', title: '分组名称', width: 120 },
                { field: 'STAFFNO', title: '人员ID', width: 120 },
    ...
    $("#insert_to_group").click(function () {
        ...
        var index = layer.open({
            ...
            yes: function (index, layero) {
                ...
                $.ajax({
                    type: "POST",
                    url: "../KeHu/Data_Insert_GroupByStaffno",
                    data: {
                        STAFFID: $("#kehuid").val(),
                        GID: gid
                    },
            ...
            if (layEvent == "delete") {
                layer.open({
                    ...
                    yes: function (index, layero) {
                        ...
                        $.ajax({
                            type: "POST",
                            async: false,
                            url: "../KeHu/Data_Delete_Group_Staff",
                            data: {
                ...
                layer.open({
                    ...
                    yes: function (index, layero) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "../KeHu/Data_Update_KeHu_Group_Staff",
                            data: {
                                STAFFID: $("#kehuid").val(),
                                OldGid: data.GID,
                                NewGid: gid
