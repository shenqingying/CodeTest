    ...
    if (LB > 0) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (resdata.TYPE === "S") {
                    if (LB === 1) {
                        window.open("../XZGL/EXPORT_DOWNLOAD" + "?filename=" + resdata.MESSAGE + "&filenameout=通讯费明细导出", "_self");
                    }
                    else {
                        window.open("../XZGL/EXPORT_DOWNLOAD" + "?filename=" + resdata.MESSAGE + "&filenameout=通讯费汇总导出", "_self");
                    }
                }
                else {
                    layer.alert(resdata.MESSAGE);
