...
{
    public partial class frmFujiTL : baseview
    {
        ...
        public frmFujiTL(MES_PD_SCRW_LIST[] model,string sbh,string sbhID)
        {
            InitializeComponent();
        ...
        private void qrtlbutton_Click(object sender, EventArgs e)
        {
            ...
            if (res.MES_RETURN.TYPE.Equals("S"))
            {
                ...
                if (index == -1)
                {
                    ...
                    {
                        //zybutton_Click(zybutton, new EventArgs());
                    }
        ...
        private void qhsbhbutton_Click(object sender, EventArgs e)
        {
            ...
            frmFindSBH form = new frmFindSBH(list, getUserInfo("gzzxtext"), Rigth_Type.fujitl,true);
