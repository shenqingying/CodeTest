    ...
    $("#btn_upload").click(function () {
        ...
        layer.open({
            ...
            yes: function (index, layero) {
                var sfcs;
                if (address_data.result.address_component.province == address_data.result.address_component.city) {
                    sfcs = address_data.result.address_component.province;
                }
                else {
                    sfcs = address_data.result.address_component.province + address_data.result.address_component.city;
                }
                var KQdata = {
                    //STAFFID: staffid,
                    KQDZ: address_data.result.formatted_addresses.recommend,
                    DWDZMS: sfcs + address_data.result.formatted_addresses.recommend,
                    ED: latitude,
                    JD: longitude,
                    KQRC: 800,
                    ISACTIVE: 1
