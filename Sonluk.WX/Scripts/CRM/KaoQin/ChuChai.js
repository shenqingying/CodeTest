        ...
        success: function (resdata) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                $("#div_result").append('<table border="0" width="100%"><tr><td>序号：' + xuhao + '</td><td>审核状态：' + status + '</td></tr>'
                    ...
                    + '<tr><td width="200">本区域出差：' + way + '</td><td width="200">正常业务出差：' + other_way + '</td><td width="60"><button id="btn_edit' + xuhao + '" class="layui-btn layui-btn-xs" style="width:100%;height:30px">编辑</button></td></tr>'
                    + '<tr><td colspan="2">开始日期：' + data[i].SJKSSJ + '</td></tr>'
                    + '<tr><td colspan="2">结束日期：' + data[i].SJCCJSSJ + '</td><td><button id="btn_delete' + xuhao + '" class="layui-btn layui-btn-xs layui-btn-danger" style="width:100%;height:30px">删除</button></td></tr>'
                    + '<tr><td>工作日天数：' + data[i].JHCCTS + '</td><td></td></tr>'
                    + '<tr><td>出行方式：' + data[i].CXFSDES + '</td><td>预计总金额：' + data[i].YJJE + '</td><td><button id="btn_submit' + xuhao + '" class="layui-btn layui-btn-xs" style="width:100%;height:30px">提交OA</button></td></tr>'
