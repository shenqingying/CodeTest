...
namespace Sonluk.Entities.CRM
{
    public class CRM_KH_KH
    {
        ...
        {
            get { return _MANAGEWAY; }
            set { _MANAGEWAY = value; }
        }
        int _PAYWAY;
        ...
        {
            get { return _SUPPORTOTHER; }
            set { _SUPPORTOTHER = value; }
        }
        int _ISNEW;
