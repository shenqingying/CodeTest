...
namespace Sonluk.Entities.CRM
{
    public class CRM_KQ_YGQJList
    {
        ...
        {
            get { return _DEPNAMEDES; }
            set { _DEPNAMEDES = value; }
        }
        string _QJLBDES;
